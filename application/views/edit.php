        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Data Penerima</h1>
                    <p class="mb-4"></p>
                    <div class="mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    ...
                                    <input class="form-control form-control-user" input type="text" name="nik" value="<?php echo $u->nik ?>">
                                    <p> Nama <br> 
                                    <input class="form-control form-control-user" input type="text" name="nama" value="<?php echo $u->nama ?>">
                                    <p> Jenis Barang <br> 
                                    <input class="form-control form-control-user" input type="text" name="jenis_barang" value="<?php echo $u->jenis_barang ?>">
                                    <p> Kecamatan <br> 
                                    <input class="form-control form-control-user" input type="text" name="kecamatan" value="<?php echo $u->kecamatan ?>">
                                    <p> Alamat <br> 
                                    <input class="form-control form-control-user" input type="text" name="alamat" value="<?php echo $u->alamat ?>">
                                    <p> No HP RT <br> 
                                    <input class="form-control form-control-user" input type="text" name="nohprt" value="<?php echo $u->nohprt ?>">
                                    <br> <input class="btn btn-primary py-2 px-3 me-2" type="submit" value="Simpan">
                                </div>   
                            </div>
                        </div>
                    </form>	
