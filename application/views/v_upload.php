...
<head>
    ...
    <title>Import Data Penerima</title>
                    ...
                    <div class="card shadow mb-1">
                        <div class="card-header py-3">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                                <p> Masukkan Excel berisi data yang dibutuhkan</p>
                                <form action="<?php echo base_url('crud/upload')?>" enctype="multipart/form-data" method="post">
                                <input class="btn btn-primary py-1 px-3 me-2" type="file" name="upload_excel" required/>
                                <input class="btn btn-primary py-2 px-3 me-2" type="submit" value="Upload" />
