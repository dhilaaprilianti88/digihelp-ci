...
<body id="page-top">
 ...
 <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Penerima</h1>
                    <p class="mb-4">Isi formulir di bawah ini dengan data yang sesuai</p>
                    <div class="mb-4">                    
                    </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    <p> NIK <br> 
                                    <input class="form-control form-control-user" input type="text" name="nik" >
                                    <p> Nama <br> 
                                    <input class="form-control form-control-user" input type="text" name="nama" >
                                    <p> Jenis Barang <br> 
                                    <input class="form-control form-control-user" input type="text" name="jenis_barang" >
                                    <p> Kecamatan <br> 
                                    <input class="form-control form-control-user" input type="text" name="kecamatan" >
                                    <p> Alamat <br> 
                                    <input class="form-control form-control-user" input type="text" name="alamat" >
                                    <p> No HP RT <br> 
                                    <input class="form-control form-control-user" input type="text" name="nohprt" >
                                    <br> <input class="btn btn-primary py-2 px-3 me-2" type="submit" value="Submit">
                                </div>   
                            </div>
                        </div>
                    </form>	
